...
<section class="container">
    <section class="notice-banner" style="background-image: url('{{ url('storage/app/public/' . $notice->poster) }}')">
        ...
        <p>Escrito por <strong>Erick Rodrigues</strong> em <strong>{{ $notice->createdAtFormat }}</strong></p>            <p><i class="fa fa-comment"></i> {{ $notice->comments->where('visible', true)->count() }}</p>
